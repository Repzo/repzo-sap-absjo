  ...
  try {
    ...
    if (body.creator.type == "rep") {
      repzo_rep = await repzo.rep.get(
        (_e = body === null || body === void 0 ? void 0 : body.creator) ===
          null || _e === void 0
          ? void 0
          : _e._id
      );
    ...
    const repzo_client = await repzo.client.get(
      body === null || body === void 0 ? void 0 : body.client_id
    );
    if (!repzo_client)
    ...
    if (body === null || body === void 0 ? void 0 : body.LinkedTxn) {
      const sap_open_invoices = await get_invoice_from_sap(SAP_HOST_URL, {
        ...
        InvoiceId:
          (_g =
            (_f =
              body === null || body === void 0 ? void 0 : body.LinkedTxn) ===
              null || _f === void 0
              ? void 0
      ...
      sap_payment.InvoiceTotal =
        ((_h = body === null || body === void 0 ? void 0 : body.LinkedTxn) ===
          null || _h === void 0
          ? void 0
    ...
    if (body.payment_type == "check") {
      ...
      const repzo_bank = await repzo.bank.get(
        (_j = body.check) === null || _j === void 0 ? void 0 : _j.bank
      );
      if (!repzo_bank)
      ...
      sap_payment.ChequeDate = moment(
        (_l = body.check) === null || _l === void 0 ? void 0 : _l.check_date,
        "YYYY-MM-DD"
      ).format("YYYYMMDD");
      sap_payment.ChequeNumber =
        (_m = body.check) === null || _m === void 0 ? void 0 : _m.check_number;
