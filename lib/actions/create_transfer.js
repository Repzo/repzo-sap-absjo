...
export const create_transfer = async (event, options) => {
    ...
    try {
        ...
        const repzo_products = await get_data(repzo.product, "_id", Object.keys(repzo_product_ids), { populatedKeys: ["measureunit"] });
        ...
        for (let i = 0; i < ((_g = repzo_transfer.variants) === null || _g === void 0 ? void 0 : _g.length); i++) {
            ...
            if (!repzo_product) {
                console.log(`Product with _id: ${repzo_transfer_item.product_id} was not found In Repzo`);
            ...
            if (!(repzo_measure_unit === null || repzo_measure_unit === void 0 ? void 0 : repzo_measure_unit._id)) {
                console.log(`Measureunit with _id: ${(_h = repzo_product.sv_measureUnit) === null || _h === void 0 ? void 0 : _h.toString()} was not found`);
