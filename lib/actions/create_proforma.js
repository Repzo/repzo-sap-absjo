...
export const create_proforma = async (event, options) => {
    ...
    try {
        ...
        const repzo_taxes = await get_data(repzo.tax, "_id", Object.keys(repzo_tax_ids));
        const repzo_measureunits = await get_data(repzo.measureunit, "_id", Object.keys(repzo_measureunit_ids));
        const repzo_products = await get_data(repzo.product, "_id", Object.keys(repzo_product_ids));
        ...
        for (let i = 0; i < ((_g = repzo_proforma === null || repzo_proforma === void 0 ? void 0 : repzo_proforma.items) === null || _g === void 0 ? void 0 : _g.length); i++) {
            ...
            // Get Repzo Tax
            const repzo_tax = repzo_taxes === null || repzo_taxes === void 0 ? void 0 : repzo_taxes.find((t) => { var _a, _b, _c; return ((_a = t._id) === null || _a === void 0 ? void 0 : _a.toString()) == ((_c = (_b = item.tax) === null || _b === void 0 ? void 0 : _b._id) === null || _c === void 0 ? void 0 : _c.toString()); });
            if (!repzo_tax)
                throw `Tax with _id: ${item.tax._id} not found in Repzo`;
            // Get Repzo UoM
            const repzo_measureunit = repzo_measureunits === null || repzo_measureunits === void 0 ? void 0 : repzo_measureunits.find((m) => { var _a, _b, _c; return ((_a = m._id) === null || _a === void 0 ? void 0 : _a.toString()) == ((_c = (_b = item.measureunit) === null || _b === void 0 ? void 0 : _b._id) === null || _c === void 0 ? void 0 : _c.toString()); });
            if (!repzo_measureunit)
                throw `Uom with _id: ${(_h = item.measureunit) === null || _h === void 0 ? void 0 : _h._id} not found in Repzo`;
            // Get Repzo Product
            const repzo_product = repzo_products === null || repzo_products === void 0 ? void 0 : repzo_products.find((p) => { var _a, _b, _c; return ((_a = p._id) === null || _a === void 0 ? void 0 : _a.toString()) == ((_c = (_b = item.variant) === null || _b === void 0 ? void 0 : _b.product_id) === null || _c === void 0 ? void 0 : _c.toString()); });
            if (!repzo_product)
            ...
            items.push({
                ...
                Brand: (_j = repzo_product.integration_meta) === null || _j === void 0 ? void 0 : _j.BRAND,
                Department: ((_k = repzo_rep === null || repzo_rep === void 0 ? void 0 : repzo_rep.integration_meta) === null || _k === void 0 ? void 0 : _k.DEPARTMENTCODE) ||
                    ((_l = options.data) === null || _l === void 0 ? void 0 : _l.DepartmentCode), // "D2"
            });
        }
        const sap_invoice = {
            ...
            SalPersCode: repzo_rep
                ...
                : (_m = options.data) === null || _m === void 0 ? void 0 : _m.SalPersCode,
