...
export declare const update_bench_time: (repzo: Repzo, app_id: string, key: string, value: string, format?: string | undefined) => Promise<void>;
export declare const updateAt_query: (QUERY: string, options_formData: any, bench_time_key: string) => string;
export declare const get_data_from_sap: (_path: string, default_res: any, serviceEndPoint: string, serviceApiKey: string, query?: string | undefined) => Promise<any>;
export declare const set_error: (error_res: any) => any;
export declare const date_formatting: (date: string | number | undefined, format: string) => string | number | undefined;
export declare const get_data: (service: any, key: string, query_array: any[], extra_query?: {
    [key: string]: any;
}) => Promise<any[]>;
export {};
