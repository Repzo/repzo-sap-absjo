...
export const sync_price_list = async (commandEvent) => {
    ...
    try {
        ...
        for (let i = 0; i < priceLists_names.length; i++) {
            ...
            if (!repzo_price_list) {
                ...
                try {
                    ...
                    console.log("Create Price List Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                ...
                try {
                    ...
                    console.log("Update Price List Failed >> ", (_k = e === null || e === void 0 ? void 0 : e.response) === null || _k === void 0 ? void 0 : _k.data, body);
                    failed_docs_report.push({
                        method: "update",
        ...
        await commandLog
            .addDetail(`${(_l = repzo_all_priceLists === null || repzo_all_priceLists === void 0 ? void 0 : repzo_all_priceLists.data) === null || _l === void 0 ? void 0 : _l.length} Price Lists in Repzo`)
            .commit();
        if (!((_m = repzo_all_priceLists === null || repzo_all_priceLists === void 0 ? void 0 : repzo_all_priceLists.data) === null || _m === void 0 ? void 0 : _m.length))
            throw `No Price Lists was found On Repzo`;
        for (let priceList_name in priceLists_withItems) {
            const repzo_PriceList = (_o = repzo_all_priceLists === null || repzo_all_priceLists === void 0 ? void 0 : repzo_all_priceLists.data) === null || _o === void 0 ? void 0 : _o.find((pl) => { var _a; return ((_a = pl.integration_meta) === null || _a === void 0 ? void 0 : _a.id) == `${nameSpace}_${priceList_name}`; });
            if (!repzo_PriceList) {
                console.log(`Price list with PLDID: ${priceList_name} was not created or disabled`);
                failed_docs_report.push({
                    method: "create",
                ...
                result.PL_items.failed +=
                    ((_p = priceLists_withItems[priceList_name]) === null || _p === void 0 ? void 0 : _p.length) || 0;
                continue;
            }
            ...
            priceLists_withItems[priceList_name].forEach((doc) => {
                if (!sap_unique_UoMs[`${doc.PLITEMID}__${doc.PLITEMUNIT}`]) {
                    console.log(`error => ${doc.PLITEMID}__${doc.PLITEMUNIT} was not found on the Uom`);
                    failed_docs_report.push({
                        method: "create",
                        // doc: priceLists_withItems[priceList_name],
                ...
                if (!priceList_items[key]) {
                    ...
                    if ((current_doc === null || current_doc === void 0 ? void 0 : current_doc.factor) > (doc === null || doc === void 0 ? void 0 : doc.factor)) {
                        priceList_items[key] = doc;
                    }
                }
            });
            ...
            for (let j = 0; j < priceListItems.length; j++) {
                ...
                const repzo_product = (_q = repzo_products === null || repzo_products === void 0 ? void 0 : repzo_products.data) === null || _q === void 0 ? void 0 : _q.find((product) => { var _a; return ((_a = product === null || product === void 0 ? void 0 : product.integration_meta) === null || _a === void 0 ? void 0 : _a.id) == `${nameSpace}_${item.PLITEMID}`; });
                if (!repzo_product) {
                    failed_docs_report.push({
                        method: "create",
                        // doc: priceLists_withItems[priceList_name],
                ...
                const repzo_product_uom = (_r = repzo_UoMs === null || repzo_UoMs === void 0 ? void 0 : repzo_UoMs.data) === null || _r === void 0 ? void 0 : _r.find((uom) => { var _a, _b; return ((_a = uom === null || uom === void 0 ? void 0 : uom._id) === null || _a === void 0 ? void 0 : _a.toString()) == ((_b = repzo_product === null || repzo_product === void 0 ? void 0 : repzo_product.sv_measureUnit) === null || _b === void 0 ? void 0 : _b.toString()); });
                if (!repzo_product_uom) {
                    failed_docs_report.push({
                        method: "create",
                        // doc: priceLists_withItems[priceList_name],
                        error_message: set_error(`Price List: ${item.PLDID} of MeasureUnit with _id: ${(_s = repzo_product === null || repzo_product === void 0 ? void 0 : repzo_product.sv_measureUnit) === null || _s === void 0 ? void 0 : _s.toString()} was not found or disabled`),
                    });
                    result.PL_items.failed++;
                    continue;
                }
                ...
                const variant = (_t = repzo_product === null || repzo_product === void 0 ? void 0 : repzo_product.variants) === null || _t === void 0 ? void 0 : _t.find((variant) => { var _a; return ((_a = variant === null || variant === void 0 ? void 0 : variant.integration_meta) === null || _a === void 0 ? void 0 : _a.id) == `${nameSpace}_${item.PLITEMID}`; });
                if (!variant) {
                    console.log(`Price List: ${item.PLDID} of Variant with PLITEMID: ${item.PLITEMID} was not found`);
                    failed_docs_report.push({
                        method: "create",
                        // doc: priceLists_withItems[priceList_name],
                ...
                if (!is_found_in_repzo_db) {
                    ...
                    try {
                        ...
                        console.log("Create PL Item Failed >> ", (_v = e === null || e === void 0 ? void 0 : e.response) === null || _v === void 0 ? void 0 : _v.data, body);
                        failed_docs_report.push({
                            method: "create",
                            // doc: body,
                            error_message: set_error(e),
                    ...
                    try {
                        ...
                        console.log("Update Price List Item Failed >> ", (_w = e === null || e === void 0 ? void 0 : e.response) === null || _w === void 0 ? void 0 : _w.data, body);
                        failed_docs_report.push({
                            method: "update",
