        ...
        for (let i = 0; i < ((_e = sap_tags === null || sap_tags === void 0 ? void 0 : sap_tags.Territories) === null || _e === void 0 ? void 0 : _e.length); i++) {
            ...
            if (!repzo_tag) {
                ...
                try {
                    ...
                    console.log("Create Tag Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                ...
                try {
                    ...
                    console.log("Update Tag Failed >> ", (_g = e === null || e === void 0 ? void 0 : e.response) === null || _g === void 0 ? void 0 : _g.data, body);
                    failed_docs_report.push({
                        method: "update",
