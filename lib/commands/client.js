    ...
    try {
        ...
        for (let i = 0; i < (sap_clients === null || sap_clients === void 0 ? void 0 : sap_clients.length); i++) {
            ...
            const body = {
                ...
                tags: tag ? [tag._id] : [],
                credit_limit: sap_client.CLIENTGROUP == "Cash Van"
                    ? 1000000000
            ...
            if (!repzo_client) {
                ...
                try {
                    ...
                    console.log("Create Client Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                ...
                try {
                    ...
                    console.log("Update Client Failed >> ", (_h = e === null || e === void 0 ? void 0 : e.response) === null || _h === void 0 ? void 0 : _h.data, body);
                    failed_docs_report.push({
                        method: "update",
        ...
        //@ts-ignore
        console.error(((_j = e === null || e === void 0 ? void 0 : e.response) === null || _j === void 0 ? void 0 : _j.data) || e);
