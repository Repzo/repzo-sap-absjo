        ...
        for (let i = 0; i < (sap_payment_terms === null || sap_payment_terms === void 0 ? void 0 : sap_payment_terms.length); i++) {
            ...
            if (!repzo_payment_term) {
                ...
                try {
                    ...
                    console.log("Create Payment Term Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                ...
                try {
                    ...
                    console.log("Update Payment Term Failed >> ", (_d = e === null || e === void 0 ? void 0 : e.response) === null || _d === void 0 ? void 0 : _d.data, body);
                    failed_docs_report.push({
                        method: "update",
