...
export const sync_disabled_client = async (commandEvent) => {
    ...
    try {
        ...
        for (let i = 0; i < pages; i += per_page) {
            ...
            if ((_b = repzo_clients_per_page === null || repzo_clients_per_page === void 0 ? void 0 : repzo_clients_per_page.data) === null || _b === void 0 ? void 0 : _b.length)
                repzo_disabled_clients.push(...repzo_clients_per_page.data);
        }
        result.repzo_total = repzo_disabled_clients === null || repzo_disabled_clients === void 0 ? void 0 : repzo_disabled_clients.length;
        await commandLog
        ...
        for (let i = 0; i < (sap_disabled_clients === null || sap_disabled_clients === void 0 ? void 0 : sap_disabled_clients.length); i++) {
            ...
            const repzo_client = repzo_disabled_clients === null || repzo_disabled_clients === void 0 ? void 0 : repzo_disabled_clients.find((r_client) => {
                var _a;
                return ((_a = r_client.integration_meta) === null || _a === void 0 ? void 0 : _a.id) ==
            ...
            if (repzo_client) {
                ...
                try {
                    ...
                    console.log("Disable Client Failed >> ", (_c = e === null || e === void 0 ? void 0 : e.response) === null || _c === void 0 ? void 0 : _c.data, {
