...
export const sync_rep = async (commandEvent) => {
    ...
    try {
        ...
        // hard code ************************************
        (_c = sap_reps === null || sap_reps === void 0 ? void 0 : sap_reps.Users) === null || _c === void 0 ? void 0 : _c.forEach((sap_rep) => {
            if (sap_rep.USERDESC.startsWith("WS ") ||
        ...
        result.repzo_total = (_d = repzo_reps === null || repzo_reps === void 0 ? void 0 : repzo_reps.data) === null || _d === void 0 ? void 0 : _d.length;
        await commandLog
            .addDetail(`${(_e = repzo_reps === null || repzo_reps === void 0 ? void 0 : repzo_reps.data) === null || _e === void 0 ? void 0 : _e.length} reps in Repzo`)
            .commit();
        for (let i = 0; i < ((_f = sap_reps === null || sap_reps === void 0 ? void 0 : sap_reps.Users) === null || _f === void 0 ? void 0 : _f.length); i++) {
            ...
            if (sap_rep.USERWHSCODE && sap_rep.USERWHSCODE != "") {
                ...
                if ((_g = warehouse_res === null || warehouse_res === void 0 ? void 0 : warehouse_res.data) === null || _g === void 0 ? void 0 : _g.length)
            ...
            const body = {
                ...
                integration_id: (_h = sap_rep.USERID) === null || _h === void 0 ? void 0 : _h.toString(),
                integration_meta: {
            ...
            if (!repzo_rep) {
                ...
                try {
                    ...
                    console.log("Create Rep Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                ...
                const found_identical_docs = db.search({
                    ...
                    DEPARTMENTCODE: (_j = repzo_rep.integration_meta) === null || _j === void 0 ? void 0 : _j.DEPARTMENTCODE,
                    USERCASHACCOUNT: (_k = repzo_rep.integration_meta) === null || _k === void 0 ? void 0 : _k.USERCASHACCOUNT,
                    USERCHECKACCTCODE: (_l = repzo_rep.integration_meta) === null || _l === void 0 ? void 0 : _l.USERCHECKACCTCODE,
                    USERWHSCODE: (_m = repzo_rep.integration_meta) === null || _m === void 0 ? void 0 : _m.USERWHSCODE,
                });
                ...
                try {
                    ...
                    console.log("Update Rep Failed >> ", (_o = e === null || e === void 0 ? void 0 : e.response) === null || _o === void 0 ? void 0 : _o.data, body);
                    failed_docs_report.push({
                        method: "update",
        ...
        //@ts-ignore
        console.error(((_p = e === null || e === void 0 ? void 0 : e.response) === null || _p === void 0 ? void 0 : _p.data) || e);
