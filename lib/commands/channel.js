...
export const sync_channel = async (commandEvent) => {
    ...
    try {
        ...
        for (let i = 0; i < (sap_channels === null || sap_channels === void 0 ? void 0 : sap_channels.length); i++) {
            ...
            if (!repzo_channel) {
                ...
                try {
                    ...
                    console.log("Create Client Channel Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                ...
                try {
                    ...
                    console.log("Update Client Channel Failed >> ", (_d = e === null || e === void 0 ? void 0 : e.response) === null || _d === void 0 ? void 0 : _d.data, body);
                    failed_docs_report.push({
                        method: "update",
        ...
        //@ts-ignore
        console.error(((_e = e === null || e === void 0 ? void 0 : e.response) === null || _e === void 0 ? void 0 : _e.data) || e);
