...
export const basic = async (commandEvent) => {
    ...
    try {
        ...
        for (let i = 0; i < required_syncing_commands.length; i++) {
            ...
            await commandLog
                .addDetail(`Start Syncing: ${(commandDes === null || commandDes === void 0 ? void 0 : commandDes.name) || command}`)
                .commit();
        ...
        //@ts-ignore
        console.error(((_b = e === null || e === void 0 ? void 0 : e.response) === null || _b === void 0 ? void 0 : _b.data) || e);
        await commandLog.load(commandEvent.sync_id);
