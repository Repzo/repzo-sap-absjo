    ...
    try {
        ...
        for (let i = 0; i < (sap_products === null || sap_products === void 0 ? void 0 : sap_products.length); i++) {
            ...
            try {
                ...
                // Tax
                const tax = (_f = repzo_taxes === null || repzo_taxes === void 0 ? void 0 : repzo_taxes.data) === null || _f === void 0 ? void 0 : _f.find((tax) => {
                    var _a;
                ...
                const product_tax = (_g = tax === null || tax === void 0 ? void 0 : tax._id) === null || _g === void 0 ? void 0 : _g.toString();
                // Category
                const category = (_h = repzo_categories === null || repzo_categories === void 0 ? void 0 : repzo_categories.data) === null || _h === void 0 ? void 0 : _h.find((category) => {
                    var _a;
                ...
                const product_category = (_j = category === null || category === void 0 ? void 0 : category._id) === null || _j === void 0 ? void 0 : _j.toString();
                // measureUnit family
                const family = await repzo.measureunitFamily.find({
                    "integration_meta.id": `${nameSpace}_${sap_product.ITEMCODE}`,
                    disabled: false,
                });
                if (!(family === null || family === void 0 ? void 0 : family.data) || ((_k = family === null || family === void 0 ? void 0 : family.data) === null || _k === void 0 ? void 0 : _k.length) != 1) {
                    throw `Family not found => ITEMCODE: ${sap_product.ITEMCODE}`;
                    continue;
                }
                const product_family = (_m = (_l = family.data[0]) === null || _l === void 0 ? void 0 : _l._id) === null || _m === void 0 ? void 0 : _m.toString();
                // measureUnit
                ...
                const product_measureUnit = (_o = measureUnit.data[0]._id) === null || _o === void 0 ? void 0 : _o.toString();
                const body = {
                    active: true,
                ...
                if (!repzo_product) {
                    ...
                    try {
                        ...
                        console.log("Create Product Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                    ...
                    if ((_p = repzo_product === null || repzo_product === void 0 ? void 0 : repzo_product.variants) === null || _p === void 0 ? void 0 : _p.length) {
                        (_q = body === null || body === void 0 ? void 0 : body.variants) === null || _q === void 0 ? void 0 : _q.forEach((variant) => {
                            var _a;
                    ...
                    try {
                        ...
                        console.log("Update Product Failed >> ", (_r = e === null || e === void 0 ? void 0 : e.response) === null || _r === void 0 ? void 0 : _r.data, body);
                        failed_docs_report.push({
                            method: "update",
        ...
        //@ts-ignore
        console.error(((_s = e === null || e === void 0 ? void 0 : e.response) === null || _s === void 0 ? void 0 : _s.data) || e);
