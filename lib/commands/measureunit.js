        ...
        Object.values(byProduct).forEach((units) => {
            ...
            if (max_unit.sap_product_UoMs.length > 1) {
                ...
                if (!max_unit.default_unit) {
                    console.log("Create/Update Measure Unit Failed >> ", `${(_a = max_unit === null || max_unit === void 0 ? void 0 : max_unit.sap_product_UoMs[0]) === null || _a === void 0 ? void 0 : _a.ITEMCODE} Could not found the base_unit`, units);
                    failed_docs_report.push({
                        method: "create",
                        doc_id: ((_b = max_unit === null || max_unit === void 0 ? void 0 : max_unit.sap_product_UoMs[0]) === null || _b === void 0 ? void 0 : _b.ITEMCODE) || ((_c = units[0]) === null || _c === void 0 ? void 0 : _c.ITEMCODE),
                        doc: units,
                        error_message: set_error(`Create/Update Measure Unit Failed >> ${(_d = max_unit === null || max_unit === void 0 ? void 0 : max_unit.sap_product_UoMs[0]) === null || _d === void 0 ? void 0 : _d.ITEMCODE} Could not found the base_unit`),
                    });
                    result.failed++;
                    return;
                }
        ...
        for (let i = 0; i < (unique_UoMs === null || unique_UoMs === void 0 ? void 0 : unique_UoMs.length); i++) {
            ...
            if (!repzo_UoM) {
                ...
                try {
                    ...
                    console.log("Create Measure Unit Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                    failed_docs_report.push({
                        method: "create",
                        doc: body,
                ...
                try {
                    ...
                    console.log("Update Measure Unit Failed >> ", (_g = e === null || e === void 0 ? void 0 : e.response) === null || _g === void 0 ? void 0 : _g.data, body);
                    failed_docs_report.push({
                        method: "update",
