...
export const get_data_from_sap = async (_path, default_res, // if no data was found
...
export const set_error = (error_res) => {
    ...
    try {
        if (error_res) {
            ...
            else if (error_res.message || ((_a = error_res.response) === null || _a === void 0 ? void 0 : _a.data)) {
                return {
                    code: (_c = (_b = error_res.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.code,
                    message: ((_d = error_res.response) === null || _d === void 0 ? void 0 : _d.data.message) || error_res.message,
...
export const get_data = async (service, key, query_array, extra_query = {}) => {
    ...
    try {
        ...
        for (let i = 0; i < pages; i += per_page) {
            ...
            if ((_a = repzo_data === null || repzo_data === void 0 ? void 0 : repzo_data.data) === null || _a === void 0 ? void 0 : _a.length)
